      ...
      <div className="hero">
        ...
        <div className="hero_caption">
          ...
          <p className="caption_title">
            Stranger Things is an American science fiction drama television
            series created by the Duffer Brothers for Netflix
          </p>
          <div className="hero_btn">
            ...
            <button className="btn btn-dr">
              <img src={info} alt="" /> More Info
            </button>
          </div>
          <TitleCard titel={"Populer"} />
        </div>
      </div>
      <div className="crd">
